...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = alloy_1.default.createWidget('widget1', 'widget', { __parentSymbol: _this["index"], });
        _this["__alloyId0"].setParent(_this["index"]);
        _this["__alloyId1"] = alloy_1.default.createWidget('widget2', 'widget', { __parentSymbol: _this["index"], });
        _this["__alloyId1"].setParent(_this["index"]);
        _this["__alloyId2"] = alloy_1.default.createController('widget', { __parentSymbol: _this["index"], });
        _this["__alloyId2"].setParent(_this["index"]);
        // </viewCode>
