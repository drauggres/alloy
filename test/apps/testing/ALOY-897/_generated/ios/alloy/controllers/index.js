...
function Controller() {
  ...
  { top: 200, width: 200, height: 50, title: 'OPEN WINDOW', id: "__alloyId2" });

  $.__views["index"].add($.__views["__alloyId2"]);
  openWindow ? $.addListener($.__views["__alloyId2"], 'click', openWindow) : __defers['$.__views["__alloyId2"]!click!openWindow'] = true;exports.destroy = function () {};
