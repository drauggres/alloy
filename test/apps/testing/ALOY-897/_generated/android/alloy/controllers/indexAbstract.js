...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId2"] = Ti.UI.createButton({ top: 200, width: 200, height: 50, title: 'OPEN WINDOW', });
        _this["index"].add(_this["__alloyId2"]);
        _this["__alloyId2"] && _this.addListener(_this["__alloyId2"], 'click', _this.openWindow.bind(_this));
        // </viewCode>
