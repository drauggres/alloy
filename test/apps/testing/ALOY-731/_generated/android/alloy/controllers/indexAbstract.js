...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createTextField({ top: "10dp", left: "15dp", right: "15dp", height: "40dp", borderStyle: Ti.UI.INPUT_BORDERSTYLE_ROUNDED, hintText: "I clear on edit", clearOnEdit: true, });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId1"] = Ti.UI.createTextField({ top: "10dp", left: "15dp", right: "15dp", height: "40dp", borderStyle: Ti.UI.INPUT_BORDERSTYLE_ROUNDED, hintText: "I don't clear on edit", clearOnEdit: false, });
        _this["index"].add(_this["__alloyId1"]);
        if ((OS_ANDROID)) {
            _this["__alloyId2"] = Ti.UI.createTextArea({ top: "10dp", left: "15dp", right: "15dp", height: "70dp", borderRadius: 8, borderColor: "#888", borderWidth: 2, hintText: "I clear on edit", clearOnEdit: true, });
            _this["index"].add(_this["__alloyId2"]);
        }
        if ((OS_ANDROID)) {
            _this["__alloyId3"] = Ti.UI.createTextArea({ top: "10dp", left: "15dp", right: "15dp", height: "70dp", borderRadius: 8, borderColor: "#888", borderWidth: 2, hintText: "I don't clear on edit", clearOnEdit: false, });
