...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId1"] = alloy_1.default.createController('navbar', { __parentSymbol: _this["__alloyId0"], });
        _this["__alloyId1"].setParent(_this["__alloyId0"]);
        _this["label"] = Ti.UI.createLabel({ text: 'Hello, World', id: "label", });
        _this["__alloyId0"].add(_this["label"]);
