      ...
      if ($.__views["index"].activity) {
        $.__views["index"].activity.onCreateOptionsMenu = function (e) {
          ...
          doMenuClick ? $.addListener($.__views["item2"], 'click', doMenuClick) : __defers['$.__views["item2"]!click!doMenuClick'] = true;if ($.__views["index"].activity.actionBar) {
            $.__views["index"].activity.actionBar.title = "My XML Menu";$.__views["index"].activity.actionBar.backgroundImage = "/actionbackground.png";$.__views["index"].activity.actionBar.displayHomeAsUp = true;$.__views["index"].activity.actionBar.icon = "/actionicon.png";$.__views["index"].activity.actionBar.onHomeIconItemSelected = doMenuClick;}
