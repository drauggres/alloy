...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["label"] = Ti.UI.createLabel({ height: Ti.UI.SIZE, width: "90%", font: { fontSize: "24dp", fontWeight: "normal", }, textAlign: "center", color: "#f00", text: 'Check the console output and make sure that only styles relevant to the current build platform are listed in the printed array. Note also that the "platform" key has been removed entirely from the "queries" object in conditional styles.', id: "label", });
