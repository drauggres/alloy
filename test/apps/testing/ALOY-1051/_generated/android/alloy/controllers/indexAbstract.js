...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["label"] = Ti.UI.createLabel({ top: 100, width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", font: { fontFamily: "AmericanTypewriter", fontSize: 30, }, text: 'Hello, World', id: "label", });
