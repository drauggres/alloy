...
function Controller() {
  ...
  { color: "blue", font: { fontSize: "10dp", fontStyle: "italic" }, text: "You should see 6 labels above and 6 below the line", id: "explain" });
  ...
  if (true || false) {
    ...
    { text: 'android,mobileweb', id: "__alloyId1" });
  ...
  if (false || true || false) {
    ...
    { text: 'mobileweb,!ios', id: "__alloyId5" });
  ...
  { height: 0, id: "iosmobileweb" });

  $.__views["index"].add($.__views["iosmobileweb"]);
  $.__views["androidmobileweb"] = Ti.UI.createLabel(
  { height: Ti.UI.SIZE, text: "TSS: android,mobileweb", id: "androidmobileweb" });
  ...
  { height: Ti.UI.SIZE, text: "TSS: mobileweb,!ios", id: "mobilewebNotios" });

  $.__views["index"].add($.__views["mobilewebNotios"]);
  $.__views["mobilewebNotandroid"] = Ti.UI.createLabel(
  { height: 0, id: "mobilewebNotandroid" });
