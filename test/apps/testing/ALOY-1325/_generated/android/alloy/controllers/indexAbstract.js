...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        var __alloyId3 = [];
        _this["__alloyId4"] = { properties: { title: "Hello", }, };
        __alloyId3.push(_this["__alloyId4"]);
        _this["__alloyId1"] = Ti.UI.createListSection({});
        _this["__alloyId1"].items = __alloyId3;
        var __alloyId5 = [];
        __alloyId5.push(_this["__alloyId1"]);
        _this["__alloyId0"] = Ti.UI.createListView({ sections: __alloyId5, });
