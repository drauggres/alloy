...
function Controller() {
  ...
  // is executed.
  __defers['$.__views["__alloyId11"]!click!doClick'] && $.addListener($.__views["__alloyId11"], 'click', doClick);__defers['$.__views["__alloyId13"]!click!doClick'] && $.addListener($.__views["__alloyId13"], 'click', doClick);__defers['$.__views["index"]!focus!setCurrentTab'] && $.addListener($.__views["index"], 'focus', setCurrentTab);
