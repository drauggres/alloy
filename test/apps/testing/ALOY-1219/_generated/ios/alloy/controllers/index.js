...
function Controller() {
  ...
  var __alloyId18 = Alloy.Collections['heroes'] || heroes;function __alloyId19(e) {if (e && e.fromAdapter) {return;}var opts = __alloyId19.opts || {};var models = __alloyId18.models;var len = models.length;var rows = [];for (var i = 0; i < len; i++) {var __alloyId7 = models[i];__alloyId7.__transform = _.isFunction(__alloyId7.transform) ? __alloyId7.transform() : __alloyId7.toJSON();var __alloyId9 = Ti.UI.createTableViewRow(
    ...
    }$.__views["table"].setData(rows);};__alloyId18.on('fetch destroy change add remove reset', __alloyId19);
  // </dataFunctionsCode>
  ...
  Alloy['Models']['appState'].on('fetch change destroy', this.__alloyId20);exports.destroy = function () {__alloyId18 && __alloyId18.off('fetch destroy change add remove reset', __alloyId19);Alloy['Models']['appState'] && Alloy['Models']['appState'].off('fetch change destroy', this.__alloyId20);};
