...
function Controller() {
  ...
  var __alloyId18 = Alloy.Collections['heroes'] || heroes;function __alloyId19(e) {if (e && e.fromAdapter) {return;}var opts = __alloyId19.opts || {};var models = __alloyId18.models;var len = models.length;var rows = [];for (var i = 0; i < len; i++) {var __alloyId7 = models[i];__alloyId7.__transform = _.isFunction(__alloyId7.transform) ? __alloyId7.transform() : __alloyId7.toJSON();var __alloyId9 = Ti.UI.createTableViewRow(
      { title: __alloyId7.__transform.name });

      rows.push(__alloyId9);
      var __alloyId11 = Ti.UI.createTableViewRow(
      { title: "My hero is {{name}}" });

      rows.push(__alloyId11);
      var __alloyId13 = Ti.UI.createTableViewRow(
      { title: __alloyId7.__transform.title + ', by ' + __alloyId7.__transform.name });

      rows.push(__alloyId13);
      var __alloyId15 = Ti.UI.createTableViewRow(
      { title: __alloyId7.__transform.title + ' ' + __alloyId7.__transform.name });
    ...
    }$.__views["table"].setData(rows);};__alloyId18.on('fetch destroy change add remove reset', __alloyId19);modifyHero ? $.addListener($.__views["table"], 'click', modifyHero) : __defers['$.__views["table"]!click!modifyHero'] = true;$.__views["__alloyId4"] = Ti.UI.createTab(
