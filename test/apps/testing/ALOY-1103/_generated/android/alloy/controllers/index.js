...
function Controller() {
  ...
  if (Alloy.isTablet) {
    ...
    { font: { fontSize: "20dp" }, text: 'HeaderView Tablet' });
  ...
  if (!Alloy.isTablet) {
    ...
    { font: { fontSize: "20dp" }, text: 'HeaderView Handheld' });
  ...
  if (Alloy.isTablet) {
    ...
    { font: { fontSize: "20dp" }, text: 'View Tablet' });
  ...
  if (!Alloy.isTablet) {
    ...
    { font: { fontSize: "20dp" }, text: 'View Handheld' });
