...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_IOS || OS_ANDROID)) {
            _this["row1"] = Ti.UI.createTableViewRow({ font: { fontSize: "16dp", }, color: "black", id: "row1", title: "Row 1 - iOS and Android", });
            __alloyId0.push(_this["row1"]);
        }
        if ((OS_ANDROID || OS_MOBILEWEB)) {
            _this["row2"] = Ti.UI.createTableViewRow({ font: { fontSize: "16dp", }, color: "black", id: "row2", title: "Row 2 - Android and Mobileweb", });
            __alloyId0.push(_this["row2"]);
        }
        _this["container"] = Ti.UI.createTableView({ data: __alloyId0, id: "container", top: 30, });
        _this["index"].add(_this["container"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["row1"] = _this.row1;
        _this.__views["row2"] = _this.row2;
        _this.__views["container"] = _this.container;
