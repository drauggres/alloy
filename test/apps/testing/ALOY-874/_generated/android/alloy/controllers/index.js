...
function Controller() {
  ...
  { backgroundColor: "#fff", fullscreen: false, title: "table", id: "__alloyId2" });

  $.__views["__alloyId5"] = Ti.UI.createView(
  { height: 60, id: "__alloyId5" });

  $.__views["__alloyId6"] = Ti.UI.createLabel(
  { text: 'Header', id: "__alloyId6" });

  $.__views["__alloyId5"].add($.__views["__alloyId6"]);
  $.__views["__alloyId8"] = Ti.UI.createView(
  { height: 60, id: "__alloyId8" });

  $.__views["__alloyId9"] = Ti.UI.createLabel(
  { text: 'Footer', id: "__alloyId9" });

  $.__views["__alloyId8"].add($.__views["__alloyId9"]);
  $.__views["__alloyId3"] = Ti.UI.createTableView(
  { headerView: $.__views["__alloyId5"], footerView: $.__views["__alloyId8"], id: "__alloyId3" });
