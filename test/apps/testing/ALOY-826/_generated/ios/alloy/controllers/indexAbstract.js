...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        var __alloyId4 = [];
        _this["__alloyId5"] = { properties: { title: "One", }, };
        __alloyId4.push(_this["__alloyId5"]);
        _this["__alloyId6"] = { properties: { title: "Two", }, };
        __alloyId4.push(_this["__alloyId6"]);
        _this["__alloyId7"] = { properties: { title: "Three", }, };
        __alloyId4.push(_this["__alloyId7"]);
        _this["__alloyId2"] = Ti.UI.createListSection({});
        _this["__alloyId2"].items = __alloyId4;
        var __alloyId8 = [];
        __alloyId8.push(_this["__alloyId2"]);
        _this["__alloyId10"] = alloy_1.default.createController('section', {});
        __alloyId8.push(_this["__alloyId10"].getViewEx({ recurse: true }));
        _this["__alloyId0"] = Ti.UI.createListView({ sections: __alloyId8, });
