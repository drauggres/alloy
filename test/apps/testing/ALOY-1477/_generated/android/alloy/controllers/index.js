...
function Controller() {
  ...
  { top: 30, id: "__alloyId4" });

  $.__views["index"].add($.__views["__alloyId4"]);
  $.__views["__alloyId5"] = Ti.UI.createButton(
  { title: 'Create Model Should Not Error', id: "__alloyId5" });
