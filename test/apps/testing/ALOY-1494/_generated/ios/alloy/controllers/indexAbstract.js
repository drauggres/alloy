...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_IOS)) {
            _this["stepper"] = Ti.UI.iOS.createStepper({ id: "stepper", });
            _this["index"].add(_this["stepper"]);
            _this["stepper"] && _this.addListener(_this["stepper"], 'change', _this.stepperChanged.bind(_this));
        }
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["stepper"] = _this.stepper;
