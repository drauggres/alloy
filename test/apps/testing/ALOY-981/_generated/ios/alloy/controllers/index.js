...
function Controller() {
  ...
  if (true) {
    ...
    { keyboardToolbarColor: "#999", keyboardToolbarHeight: 40, height: 30, width: "80%", top: 30, borderWidth: 1, borderRadius: 3, borderColor: "#bbb", font: { fontSize: 12 }, value: "Focus to see keyboard with toolbar", keyboardToolbar: $.__views["__alloyId1"], id: "textArea" });
