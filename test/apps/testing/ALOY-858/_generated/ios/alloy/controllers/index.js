...
function Controller() {
  ...
  { top: "30dp", color: "#222", font: { fontSize: "12dp", fontWeight: "bold" }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, left: 20, textid: "hello_world", id: "__alloyId0" });

  $.__views["index"].add($.__views["__alloyId0"]);
  $.__views["__alloyId1"] = Ti.UI.createLabel(
  { top: "30dp", color: "#222", font: { fontSize: "12dp", fontWeight: "bold" }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, left: 20, textid: "mytheme__hello_world", id: "__alloyId1" });

  $.__views["index"].add($.__views["__alloyId1"]);
  $.__views["__alloyId2"] = Ti.UI.createImageView(
  { image: "/images/a.png", id: "__alloyId2" });
