...
function Controller() {
  ...
  var __alloyId12 = Alloy.Collections['book'] || book;function __alloyId13(e) {if (e && e.fromAdapter) {return;}var opts = __alloyId13.opts || {};var models = __alloyId12.models;var len = models.length;var rows = [];for (var i = 0; i < len; i++) {var __alloyId8 = models[i];__alloyId8.__transform = _.isFunction(__alloyId8.transform) ? __alloyId8.transform() : __alloyId8.toJSON();var __alloyId9 = Ti.UI.createTableViewRow(
    ...
    }$.__views["tableview"].setData(rows);};__alloyId12.on('fetch destroy change add remove reset', __alloyId13);
  // </dataFunctionsCode>
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", text: "- Reading List -" });
  ...
  this.__alloyId14 = function () {
    Alloy['Models']['book'].__transform = _.isFunction(Alloy['Models']['book'].transform) ? Alloy['Models']['book'].transform() : Alloy['Models']['book'].toJSON();this.__alloyId2.text = Alloy['Models']['book']['__transform']['title'];
    this.__alloyId3.text = 'Written by ' + Alloy['Models']['book']['__transform']['author'];
    this.__alloyId5.text = Alloy['Models']['book']['__transform']['title'];
    this.__alloyId6.text = 'Written by ' + Alloy['Models']['book']['__transform']['author'];
    this.__alloyId7.text = 'Title: ' + Alloy['Models']['book']['__transform']['title'] + ', by ' + Alloy['Models']['book']['__transform']['author'] + ' :)';
  }.bind(this);
  Alloy['Models']['book'].on('fetch change destroy', this.__alloyId14);exports.destroy = function () {__alloyId12 && __alloyId12.off('fetch destroy change add remove reset', __alloyId13);Alloy['Models']['book'] && Alloy['Models']['book'].off('fetch change destroy', this.__alloyId14);};
