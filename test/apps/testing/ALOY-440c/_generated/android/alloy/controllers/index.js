...
function Controller() {
  ...
  const __alloyId7 = () => {
    ...
    if ($.__views["index"].activity) {
      $.__views["index"].activity.onCreateOptionsMenu = e => {
        var __alloyId6 = { title: "Add", showAsAction: Ti.Android.SHOW_AS_ACTION_ALWAYS };
        if (false) {
  ...
  $.__views["__alloyId8"] = Ti.UI.createPicker(
  { backgroundColor: "black", width: Ti.UI.FILL, height: Ti.UI.SIZE, selectionIndicator: true, top: 0 });
  ...
  $.__views["__alloyId8"].add(__alloyId9);
  $.__views["__alloyId15"] = Ti.UI.createTableView(
  { top: 100 });

  $.__views["index"].add($.__views["__alloyId15"]);
  $.__views["__alloyId21"] = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", font: { fontSize: "15dp" }, text: 'Click the ActionBar icon to add a row' });
