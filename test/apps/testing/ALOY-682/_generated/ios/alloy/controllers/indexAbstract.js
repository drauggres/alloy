...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["win"] = Ti.UI.createWindow({ id: "win", backgroundColor: "#fff", });
        _this["win"] && _this.addTopLevelView(_this["win"]);
        _this["index"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", text: 'My ID will cause a compile warning', id: "index", });
        _this["win"].add(_this["index"]);
        // </viewCode>
