...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ backgroundColor: "#888", id: "index", });
        _this["index"] && _this.addTopLevelView(_this["index"]);
        _this["label"] = Ti.UI.createLabel({ backgroundColor: "#00f", width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontSize: 12, }, text: 'This should be white text with a blue background on a gray window', id: "label", });
