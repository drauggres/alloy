...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["staticLabel"] = Ti.UI.createLabel({ color: "#a00", font: { fontSize: "32dp", fontWeight: "bold", }, textAlign: "center", top: "15dp", shadowColor: "#aaa", shadowOffset: { x: 2, y: 2, }, text: 'static text', id: "staticLabel", });
