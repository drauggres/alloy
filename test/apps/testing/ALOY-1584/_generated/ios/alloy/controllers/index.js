...
function Controller() {
  ...
  { title: "My Test App", backgroundColor: "gray", theme: "Theme.AppCompat.NoTitleBar", id: "index" });

  $.__views["index"] && $.addTopLevelView($.__views["index"]);
  $.__views["toolBarID"] = Ti.UI.createToolbar(
  { id: "toolBarID", title: "MyMenu", subtitle: "Subtitle", width: Ti.UI.FILL, top: 0, barColor: "#639851" });
