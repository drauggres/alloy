...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ color: "#000", left: 20, right: 20, text: 'Check the Alloy compile log and ensure that the sync adapters are not listed in the processed files.', });
