...
function Controller() {
  ...
  { id: "appVersion", textAlign: "centerAlign", text: Ti.App.getVersion() + 'test', height: Ti.UI.SIZE, top: 50 });

  $.__views["index"].add($.__views["appVersion"]);
  $.__views["appVersion"] = Ti.UI.createLabel(
  { id: "appVersion", textAlign: "centerAlign", text: 'test' + Ti.App.getVersion(), height: Ti.UI.SIZE, top: 100 });
