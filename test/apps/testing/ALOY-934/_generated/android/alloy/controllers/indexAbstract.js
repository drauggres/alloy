...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_ANDROID)) {
            ...
            _this["__alloyId11"] = Ti.UI.createLabel({ font: { fontSize: "14dp", }, text: "In an AndroidView", });
            _this["__alloyId10"].add(_this["__alloyId11"]);
        }
        _this["dialog"] = Ti.UI.createOptionDialog({ options: __alloyId3, buttonNames: __alloyId8, androidView: _this["__alloyId10"], id: "dialog", title: "Delete File?", });
        _this["__alloyId12"] = Ti.UI.createLabel({ font: { fontSize: "14dp", }, text: "Click for OptionDialog", });
