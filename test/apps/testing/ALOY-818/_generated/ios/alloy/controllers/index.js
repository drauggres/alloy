...
function Controller() {
  ...
  if (Alloy.isTablet) {
    ...
    { title: "Main Window", id: "__alloyId1" });

    $.__views["__alloyId2"] = Ti.UI.createLabel(
    { text: 'I am the master view', id: "__alloyId2" });

    $.__views["__alloyId1"].add($.__views["__alloyId2"]);
    $.__views["__alloyId0"] = Ti.UI.createNavigationWindow(
    { window: $.__views["__alloyId1"], id: "__alloyId0" });

    $.__views["__alloyId4"] = Ti.UI.createWindow(
    { title: "Detail Window", id: "__alloyId4" });

    $.__views["__alloyId5"] = Ti.UI.createLabel(
    { text: 'I am the detail view.', id: "__alloyId5" });

    $.__views["__alloyId4"].add($.__views["__alloyId5"]);
    $.__views["__alloyId3"] = Ti.UI.createNavigationWindow(
    { window: $.__views["__alloyId4"], id: "__alloyId3" });
  ...
  if (!Alloy.isTablet) {
    ...
    { text: 'This app is only supported on iPad', id: "__alloyId6" });
