...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ backgroundColor: "#fff", layout: "vertical", modal: false, exitOnClose: true, id: "index", });
        _this["index"] && _this.addTopLevelView(_this["index"]);
        _this["__alloyId0"] = Ti.UI.createLabel({ top: 20, text: "\u2764\u263a\nnext line", });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId1"] = Ti.UI.createLabel({ text: '\u2764\u263a\nnext line', top: 20, });
        _this["index"].add(_this["__alloyId1"]);
        _this["code"] = Ti.UI.createLabel({ text: "❤☺\nnext line", top: 20, id: "code", });
        _this["index"].add(_this["code"]);
        // </viewCode>
