...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ text: 'Hello', top: 20, width: 100, backgroundColor: "#ccc", });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId1"] = Ti.UI.createLabel({ text: L('hello_world'), });
        _this["index"].add(_this["__alloyId1"]);
        _this["__alloyId2"] = Ti.UI.createLabel({ text: L('hello_world'), });
        _this["index"].add(_this["__alloyId2"]);
        _this["__alloyId3"] = Ti.UI.createTextField({ value: 'Hello', top: 20, width: 100, backgroundColor: "#ccc", });
        _this["index"].add(_this["__alloyId3"]);
        _this["__alloyId4"] = Ti.UI.createTextField({ value: L('hello_world'), });
        _this["index"].add(_this["__alloyId4"]);
        _this["__alloyId5"] = Ti.UI.createTextField({ value: L('hello_world'), });
        _this["index"].add(_this["__alloyId5"]);
        _this["__alloyId6"] = Ti.UI.createTextArea({ value: 'Hello', top: 20, width: 100, backgroundColor: "#ccc", });
        _this["index"].add(_this["__alloyId6"]);
        _this["__alloyId7"] = Ti.UI.createTextArea({ value: L('hello_world'), });
        _this["index"].add(_this["__alloyId7"]);
        _this["__alloyId8"] = Ti.UI.createTextArea({ value: L('hello_world'), });
