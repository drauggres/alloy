...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["lbl"] = Ti.UI.createLabel({ text: 'Click to show MenuPopup', id: "lbl", });
        _this["index"].add(_this["lbl"]);
        if ((OS_IOS)) {
            var __alloyId1 = [];
            __alloyId1.push("Hello");
            __alloyId1.push("World");
            _this["popup"] = Ti.UI.iOS.createMenuPopup({ items: __alloyId1, id: "popup", });
            _this["popup"] && _this.addListener(_this["popup"], 'click', _this.popupClick.bind(_this));
        }
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["lbl"] = _this.lbl;
        _this.__views["popup"] = _this.popup;
