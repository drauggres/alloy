...
function Controller() {
  ...
  { color: "#000", height: Ti.UI.SIZE, width: Ti.UI.SIZE, top: 15, backgroundColor: "#ccf", text: 'label 1', apiName: "Ti.UI.Label", classes: ["someClass"] });

  $.__views["labels"].add($.__views["__alloyId2"]);
  $.__views["__alloyId3"] = Ti.UI.createLabel(
  { color: "#000", height: Ti.UI.SIZE, width: Ti.UI.SIZE, top: 15, backgroundColor: "#ccf", text: 'label 2', apiName: "Ti.UI.Label", classes: ["someClass"] });

  $.__views["labels"].add($.__views["__alloyId3"]);
  $.__views["__alloyId4"] = Ti.UI.createLabel(
  { color: "#000", height: Ti.UI.SIZE, width: Ti.UI.SIZE, top: 15, backgroundColor: "#ccf", text: 'label 3', apiName: "Ti.UI.Label", classes: ["someClass"] });
