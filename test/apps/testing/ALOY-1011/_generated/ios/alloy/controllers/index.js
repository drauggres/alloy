...
function Controller() {
  ...
  { bottom: 10, height: 200, backgroundColor: "orange", id: "bottomview" });

  $.__views["index"].add($.__views["bottomview"]);
  $.__views["viewlabel"] = Ti.UI.createLabel(
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontSize: "20dp" }, text: "Not an Android!", id: "viewlabel" });
