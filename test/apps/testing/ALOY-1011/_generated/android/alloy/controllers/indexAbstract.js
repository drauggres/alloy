...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
            ...
            var __alloyId2_1 = function (e) {
                ...
                if (e.source.activity) {
                    e.source.activity.onCreateOptionsMenu = function (e) {
                        ...
                        _this["item1"] && _this.addListener(_this["item1"], 'click', _this.doMenuClick1.bind(_this));
                        ...
                        _this["item2"] && _this.addListener(_this["item2"], 'click', _this.doMenuClick2.bind(_this));
                        _this["index"].activity.actionBar.title = "index ID Menu Title ";
                        _this["index"].activity.actionBar.subtitle = "index ID subtitle";
                    };
                }
                else {
        ...
        if ((OS_ANDROID)) {
            _this["label"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontSize: "20dp", }, text: "class label subfolder - you should see this", id: "label", });
            _this["index"].add(_this["label"]);
            _this["label"] && _this.addListener(_this["label"], 'click', _this.doClick.bind(_this));
        }
        _this["bottomview"] = Ti.UI.createView({ bottom: 10, height: 200, backgroundColor: "red", id: "bottomview", });
        _this["index"].add(_this["bottomview"]);
        _this["viewlabel"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontSize: "20dp", }, text: "Android platform!", id: "viewlabel", });
        _this["bottomview"].add(_this["viewlabel"]);
        // </viewCode>
        ...
        _this.__views["viewlabel"] = _this.viewlabel;
        _this.__views["bottomview"] = _this.bottomview;
