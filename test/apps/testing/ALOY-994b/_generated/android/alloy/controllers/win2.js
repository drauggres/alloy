...
function Controller() {
  ...
  function __alloyId23() {
    ...
    if ($.__views["win2"].activity) {
      $.__views["win2"].activity.onCreateOptionsMenu = function (e) {
        var __alloyId20 = { title: "require 1", icon: "/ic_menu_goto.png", id: "__alloyId19" };
        if (false) {
        ...
        doClick ? $.addListener($.__views["__alloyId19"], 'click', doClick) : __defers['$.__views["__alloyId19"]!click!doClick'] = true;var __alloyId22 = { title: "require 2", icon: "/ic_menu_manage.png", id: "__alloyId21" };
        if (false) {
        ...
        $.__alloyId21 = $.__views["__alloyId21"];
  ...
  $.__views["win2"].addEventListener('open', __alloyId23);$.__views["__alloyId24"] = Ti.UI.createLabel(
  { color: "#fff", font: { fontSize: "18dp", fontWeight: "bold" }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, text: 'Window 2', id: "__alloyId24" });

  $.__views["win2"].add($.__views["__alloyId24"]);
  $.__views["__alloyId25"] = Ti.UI.createLabel(
  { color: "#fff", font: { fontSize: "18dp", fontWeight: "bold" }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, text: 'Press the menu button', bottom: "20dp", id: "__alloyId25" });
