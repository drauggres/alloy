...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ color: "#fff", font: { fontSize: 24, fontWeight: "bold", }, bottom: 15, height: 120, width: 300, textAlign: "center", text: "you should only see this on non-iOS builds", backgroundColor: "#a00", borderWidth: 2, borderRadius: 8, borderColor: "#000", });
