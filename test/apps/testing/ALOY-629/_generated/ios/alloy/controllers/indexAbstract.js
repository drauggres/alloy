...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["notes"] = Ti.UI.createLabel({ top: 10, left: 15, right: 15, height: Ti.UI.SIZE, textAlign: "left", color: "#000", font: { fontSize: 14, fontWeight: "normal", }, text: 'Below you should see a red box with a rounded black border and white bold text inside. On iOS, it should say "global merging is working!" with a gray drop shadow. On all other platforms, it should say "you should only see this on non-iOS builds" with no drop shadow.', id: "notes", });
        _this["index"].add(_this["notes"]);
        _this["__alloyId0"] = Ti.UI.createLabel({ color: "#fff", font: { fontSize: 24, fontWeight: "bold", }, bottom: 15, height: 120, width: 300, textAlign: "center", text: "global merging is working!", backgroundColor: "#a00", borderWidth: 2, borderRadius: 8, borderColor: "#000", shadowColor: "#888", shadowOffset: { x: 2, y: 2, }, });
        _this["index"].add(_this["__alloyId0"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["notes"] = _this.notes;
