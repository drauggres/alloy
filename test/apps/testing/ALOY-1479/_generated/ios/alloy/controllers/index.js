...
function Controller() {
  ...
  { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", top: 20, id: "__alloyId4" });
  ...
  { sections: __alloyId36, height: Ti.UI.SIZE, canScroll: false, defaultItemTemplate: Ti.UI.LIST_ITEM_TEMPLATE_SUBTITLE, id: "__alloyId26" });
  ...
  var __alloyId45 = Alloy.Collections['$.colinstance'] || $.colinstance;function __alloyId46(e) {if (e && e.fromAdapter) {return;}var opts = __alloyId46.opts || {};var models = __alloyId45.models;var len = models.length;var __alloyId39 = [];for (var i = 0; i < len; i++) {var __alloyId42 = models[i];__alloyId42.__transform = _.isFunction(__alloyId42.transform) ? __alloyId42.transform() : __alloyId42.toJSON();var __alloyId44 = Alloy.createController('inherit', { $model: __alloyId42 });
      __alloyId39.push(__alloyId44.getViewEx({ recurse: true }));}opts.animation ? $.__views["__alloyId38"].setItems(__alloyId39, opts.animation) : $.__views["__alloyId38"].setItems(__alloyId39);};__alloyId45.on('fetch destroy change add remove reset', __alloyId46);var __alloyId47 = [];__alloyId47.push($.__views["__alloyId38"]);$.__views["__alloyId37"] = Ti.UI.createListView(
  { sections: __alloyId47, height: Ti.UI.SIZE, canScroll: false, defaultItemTemplate: Ti.UI.LIST_ITEM_TEMPLATE_SUBTITLE, id: "__alloyId37" });

  $.__views["index"].add($.__views["__alloyId37"]);
  var __alloyId48 = function () {$['modelinstance'].__transform = _.isFunction($['modelinstance'].transform) ? $['modelinstance'].transform() : $['modelinstance'].toJSON();$.__alloyId4.text = $['modelinstance']['__transform']['foo'];$.__alloyId5.text = $['modelinstance']['__transform']['foo'] + ' ' + $['modelinstance']['__transform']['bar'] + ' ' + $['modelinstance']['__transform']['missing'];};$['modelinstance'].on('fetch change destroy', __alloyId48);var __alloyId49 = function () {Alloy['Models']['mymodel'].__transform = _.isFunction(Alloy['Models']['mymodel'].transform) ? Alloy['Models']['mymodel'].transform() : Alloy['Models']['mymodel'].toJSON();$.__alloyId6.text = Alloy['Models']['mymodel']['__transform']['foo'];$.__alloyId7.text = Alloy['Models']['mymodel']['__transform']['foo'] + ' ' + Alloy['Models']['mymodel']['__transform']['bar'] + ' ' + Alloy['Models']['mymodel']['__transform']['missing'];};Alloy['Models']['mymodel'].on('fetch change destroy', __alloyId49);exports.destroy = function () {__alloyId14 && __alloyId14.off('fetch destroy change add remove reset', __alloyId15);__alloyId23 && __alloyId23.off('fetch destroy change add remove reset', __alloyId24);__alloyId34 && __alloyId34.off('fetch destroy change add remove reset', __alloyId35);__alloyId45 && __alloyId45.off('fetch destroy change add remove reset', __alloyId46);$['modelinstance'] && $['modelinstance'].off('fetch change destroy', __alloyId48);Alloy['Models']['mymodel'] && Alloy['Models']['mymodel'].off('fetch change destroy', __alloyId49);};
