...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_ANDROID)) {
            _this["b"] = Ti.UI.createWindow({ id: "b", });
        }
        _this["__alloyId0"] = alloy_1.default.createWidget('test.widget', 'widget', { children: [_this["b"]], __parentSymbol: _this["index"], });
        _this["__alloyId0"].setParent(_this["index"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["a"] = _this.a;
        _this.__views["b"] = _this.b;
