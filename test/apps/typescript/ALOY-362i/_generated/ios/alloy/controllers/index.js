...
var normalchild_1 = __importDefault(require("/controllers/normalchild"));
var index = /** @class */ (function (_super) {
    ...
    function index() {
        ...
        // chain calls
        _this.index.add(new normalchild_1.default().updateViews(opts).normallabel);
        _this.index.add(new normalchild_1.default({
