...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ backgroundColor: "#eee", fullscreen: false, exitOnClose: true, id: "index", });
        _this["index"] && _this.addTopLevelView(_this["index"]);
        _this["__alloyId0"] = Ti.UI.createScrollView({});
        _this["index"].add(_this["__alloyId0"]);
        _this["constantsLabel"] = Ti.UI.createLabel({ color: "#222", font: { fontSize: "14dp", fontWeight: "normal", }, top: "15dp", height: Ti.UI.SIZE, width: "90%", id: "constantsLabel", });
        _this["__alloyId0"].add(_this["constantsLabel"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["constantsLabel"] = _this.constantsLabel;
