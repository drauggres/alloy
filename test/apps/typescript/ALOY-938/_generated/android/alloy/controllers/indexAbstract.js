...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow((function () {
            var o = {};
            if (alloy_1.default.isHandheld)
                alloy_1.default.deepExtend(true, o, { title: "Handheld", });
            if (alloy_1.default.isHandheld)
                alloy_1.default.deepExtend(true, o, { title: "Handheld", });
            alloy_1.default.deepExtend(true, o, { backgroundColor: "#fff", fullscreen: false, exitOnClose: true, id: "index", });
            return o;
        })());
