...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ backgroundColor: "#ffa", id: "index", });
        _this["index"] && _this.addTopLevelView(_this["index"]);
        _this["__alloyId0"] = Ti.UI.createLabel({ color: "#000", font: { fontSize: 32, fontWeight: "bold", }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, text: "you should see this text", });
