...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["index"] && _this.addListener(_this["index"], 'click', _this.addLabels.bind(_this));
        _this["scroller"] = Ti.UI.createScrollView({ layout: "vertical", height: Ti.UI.FILL, width: Ti.UI.FILL, id: "scroller", });
        _this["index"].add(_this["scroller"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["scroller"] = _this.scroller;
