...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_IOS)) {
            ...
            var __alloyId6 = { type: 'Ti.UI.TextField', bindId: 'textfield', properties: { width: Ti.UI.FILL, bottom: 0, font: { fontSize: 12, }, borderStyle: Ti.UI.INPUT_BORDERSTYLE_ROUNDED, rightButtonMode: Ti.UI.INPUT_BUTTONMODE_ALWAYS, rightButton: __alloyId5, bindId: "textfield", autocorrect: false, hintText: "User name / e-mail address", }, };
            ...
            var __alloyId8 = [];
            _this["__alloyId9"] = { template: "inputTemplate", textfield: { value: "", }, };
            __alloyId8.push(_this["__alloyId9"]);
            _this["idSection"] = Ti.UI.createListSection({ headerTitle: "Login Id", id: "idSection", });
            _this["idSection"].items = __alloyId8;
            var __alloyId10 = [];
            __alloyId10.push(_this["idSection"]);
            _this["listView"] = Ti.UI.createListView({ top: 20, sections: __alloyId10, templates: __alloyId0, id: "listView", });
