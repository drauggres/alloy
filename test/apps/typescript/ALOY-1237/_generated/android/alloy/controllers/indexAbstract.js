...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["index"] && _this.addListener(_this["index"], 'open', _this.doOpen.bind(_this));
        _this["__alloyId0"] = Ti.UI.createLabel({ text: 'Remove the all events in this controller', });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId0"] && _this.addListener(_this["__alloyId0"], 'click', _this.doClick.bind(_this));
        // </viewCode>
