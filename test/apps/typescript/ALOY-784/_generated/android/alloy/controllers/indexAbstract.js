...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ title: "My Test App", id: "index", });
            ...
            var __alloyId2_1 = function (e) {
                ...
                if (e.source.activity) {
                    e.source.activity.onCreateOptionsMenu = function (e) {
                        ...
                        _this["index"].activity.actionBar.title = "My XML Menu";
                        ...
                        _this["index"].activity.actionBar.onHomeIconItemSelected = _this.doMenuClick.bind(_this);
                    };
                }
                else {
        ...
        _this["label"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", text: 'Hello, World', id: "label", });
