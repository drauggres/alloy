...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if ((OS_IOS)) {
            var __alloyId3 = [];
            var __alloyId7 = { title: "L(foo)", };
            __alloyId3.push(__alloyId7);
            var __alloyId8 = { title: L("foo"), };
            __alloyId3.push(__alloyId8);
            var __alloyId9 = { title: L('foo'), };
            __alloyId3.push(__alloyId9);
            _this["tb"] = Ti.UI.createTabbedBar({ labels: __alloyId3, id: "tb", });
            _this["index"].add(_this["tb"]);
        }
        ...
        if ((OS_IOS)) {
            var __alloyId12 = [];
            var __alloyId16 = { title: "L(foo)", };
            __alloyId12.push(__alloyId16);
            var __alloyId17 = { title: L('foo'), };
            __alloyId12.push(__alloyId17);
            var __alloyId18 = { title: L('foo'), };
            __alloyId12.push(__alloyId18);
            _this["bb"] = Ti.UI.createButtonBar({ labels: __alloyId12, id: "bb", });
            _this["index"].add(_this["bb"]);
        }
        // </viewCode>
