...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ touchEnabled: false, text: 'Click to show OptionDialog', });
        _this["index"].add(_this["__alloyId0"]);
        ;
        ;
        var __alloyId4 = [];
        __alloyId4.push(L('hello_world'));
        __alloyId4.push(Ti.Locale.getString('hello_world'));
        __alloyId4.push(Titanium.Locale.getString('hello_world'));
        __alloyId4.push("Hello, World!");
        _this["options"] = Ti.UI.createOptionDialog({ options: __alloyId4, id: "options", });
        _this["options"] && _this.addTopLevelView(_this["options"]);
        // </viewCode>
