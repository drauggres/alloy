...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, top: "25dp", font: { fontSize: 12, }, text: 'Support L() in XML as Label text', });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId1"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, top: "25dp", font: { fontSize: 12, }, text: L('hello_world'), });
        _this["index"].add(_this["__alloyId1"]);
        _this["__alloyId2"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, top: "25dp", font: { fontSize: 12, }, text: L('hello_world'), });
