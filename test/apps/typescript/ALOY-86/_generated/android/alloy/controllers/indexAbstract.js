...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        var __alloyId3 = [];
        _this["__alloyId4"] = alloy_1.default.createWidget('classic', 'widget', {});
        __alloyId3.push(_this["__alloyId4"].getViewEx({ recurse: true }));
        _this["__alloyId7"] = alloy_1.default.createWidget('npm', 'widget', {});
        __alloyId3.push(_this["__alloyId7"].getViewEx({ recurse: true }));
        _this["__alloyId0"] = Ti.UI.createTableView({ top: 20, data: __alloyId3, });
