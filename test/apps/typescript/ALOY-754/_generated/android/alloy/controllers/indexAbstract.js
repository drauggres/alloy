...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["b"] = Ti.UI.createButton({ width: "50%", height: Ti.UI.SIZE, title: 'click me', id: "b", });
        _this["index"].add(_this["b"]);
        _this["b"] && _this.addListener(_this["b"], 'click', _this.showAlert.bind(_this));
        // </viewCode>
