...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // <viewCode>
        var __alloyId0 = [];
        _this["index"] = Ti.UI.createWindow({ id: "index", backgroundColor: "#fff", });
        _this["__alloyId2"] = alloy_1.default.createController('next', { __parentSymbol: _this["index"], });
        _this["__alloyId2"].setParent(_this["index"]);
        _this["__alloyId1"] = Ti.UI.createTab({ window: _this["index"], });
        __alloyId0.push(_this["__alloyId1"]);
        _this["index"] = Ti.UI.createTabGroup({ tabs: __alloyId0, id: "index", });
