...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ color: "#fff", font: { fontSize: "18dp", fontWeight: "bold", }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, text: 'ActionBar/Menu only supported on Android', });
