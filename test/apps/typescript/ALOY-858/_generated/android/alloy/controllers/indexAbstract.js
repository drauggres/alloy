...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId0"] = Ti.UI.createLabel({ top: "30dp", color: "#222", font: { fontSize: "12dp", fontWeight: "bold", }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, left: 20, textid: "hello_world", });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId1"] = Ti.UI.createLabel({ top: "30dp", color: "#222", font: { fontSize: "12dp", fontWeight: "bold", }, height: Ti.UI.SIZE, width: Ti.UI.SIZE, left: 20, textid: "mytheme__hello_world", });
        _this["index"].add(_this["__alloyId1"]);
        _this["__alloyId2"] = Ti.UI.createImageView({ image: "/images/a.png", });
