...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["opt"] = alloy_1.default.createWidget('optionDialog', 'widget', { id: "opt", __parentSymbol: _this["index"], });
        _this["opt"].setParent(_this["index"]);
        _this["__alloyId0"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", text: 'As long as you don\'t see a red screen of death, this is working as expected', });
        _this["index"].add(_this["__alloyId0"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["opt"] = _this.opt;
