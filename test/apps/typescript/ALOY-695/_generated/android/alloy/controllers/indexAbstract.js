...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["index"] && _this.addListener(_this["index"], 'click', _this.addNewLabel.bind(_this));
        _this["staticLabel"] = Ti.UI.createLabel({ color: "#a00", font: { fontSize: "32dp", fontWeight: "bold", }, textAlign: "center", top: "15dp", shadowColor: "#aaa", shadowOffset: { x: 2, y: 2, }, text: 'click me to open another window', id: "staticLabel", });
        _this["index"].add(_this["staticLabel"]);
        _this["staticLabel"] && _this.addListener(_this["staticLabel"], 'click', _this.openFooBar.bind(_this));
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["staticLabel"] = _this.staticLabel;
