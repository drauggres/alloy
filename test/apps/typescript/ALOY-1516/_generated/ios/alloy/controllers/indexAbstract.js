...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["appVersion"] = Ti.UI.createLabel({ id: "appVersion", textAlign: "centerAlign", text: Ti.App.getVersion() + 'test', height: Ti.UI.SIZE, top: 50, });
        _this["index"].add(_this["appVersion"]);
        _this["appVersion"] = Ti.UI.createLabel({ id: "appVersion", textAlign: "centerAlign", text: 'test' + Ti.App.getVersion(), height: Ti.UI.SIZE, top: 100, });
        _this["index"].add(_this["appVersion"]);
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["appVersion"] = _this.appVersion;
