...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["label"] = Ti.UI.createLabel({ backgroundColor: "#00f", width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", text: 'This should be white text with a blue background on a gray window', id: "label", });
