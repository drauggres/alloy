...
var index = /** @class */ (function (_super) {
    ...
    function index() {
        ...
        _this.ScheduleGroup.open();
        return _this;
    }
    index.prototype.doOnOpen = function () {
        Ti.API.info('doOnOpen');
    };
    index.prototype.doOnFocus = function () {
        Ti.API.info('doOnFocus');
    };
    index.prototype.doSettingsMenuItem = function () {
        Ti.API.info('doSettingsMenuItem');
    };
    index.prototype.doRefresh = function () {
