...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        if (alloy_1.default.isTablet) {
            _this["__alloyId1"] = Ti.UI.createWindow({ title: "Main Window", });
            _this["__alloyId2"] = Ti.UI.createLabel({ text: 'I am the master view', });
            _this["__alloyId1"].add(_this["__alloyId2"]);
            _this["__alloyId0"] = Ti.UI.createNavigationWindow({ window: _this["__alloyId1"], });
            _this["__alloyId4"] = Ti.UI.createWindow({ title: "Detail Window", });
            _this["__alloyId5"] = Ti.UI.createLabel({ text: 'I am the detail view.', });
            _this["__alloyId4"].add(_this["__alloyId5"]);
            _this["__alloyId3"] = Ti.UI.createNavigationWindow({ window: _this["__alloyId4"], });
            _this["index"] = Ti.UI.iOS.createSplitWindow({ backgroundColor: "#fff", fullscreen: false, exitOnClose: true, masterView: _this["__alloyId0"], detailView: _this["__alloyId3"], id: "index", });
        ...
        if (!alloy_1.default.isTablet) {
            ...
            _this["index"] && _this.addTopLevelView(_this["index"]);
            _this["__alloyId6"] = Ti.UI.createLabel({ text: 'This app is only supported on iPad', });
