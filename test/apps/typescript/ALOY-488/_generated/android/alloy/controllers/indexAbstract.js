...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["starwidget"] = alloy_1.default.createWidget('starrating', 'widget', { id: "starwidget", max: 5, initialRating: 2.5, top: 20, __parentSymbol: _this["index"], });
        _this["starwidget"].setParent(_this["index"]);
        _this["label"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", font: { fontSize: 12, }, text: 'Hello, World', id: "label", top: 100, });
        ...
        // <__views>
        _this.__views["starwidget"] = _this.starwidget;
