...
var LandingPageAbstract = /** @class */ (function (_super) {
    ...
    function LandingPageAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["landingPageWindow"] = Ti.UI.createWindow({ backgroundColor: "#fff", id: "landingPageWindow", });
        _this["landingPageWindow"] && _this.addTopLevelView(_this["landingPageWindow"]);
        _this["__alloyId0"] = alloy_1.default.createController('middle', { __parentSymbol: _this["landingPageWindow"], });
        _this["__alloyId0"].setParent(_this["landingPageWindow"]);
        _this["__alloyId1"] = Ti.UI.createButton({ top: 200, width: 200, height: 50, title: 'CLOSE WINDOW', });
        _this["landingPageWindow"].add(_this["__alloyId1"]);
        _this["__alloyId1"] && _this.addListener(_this["__alloyId1"], 'click', _this.closeWindow.bind(_this));
        // </viewCode>
