...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["__alloyId0"] = Ti.UI.createWindow({});
        _this["__alloyId1"] = Ti.UI.createLabel((function () {
            var o = {};
            alloy_1.default.deepExtend(true, o, { width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#000", });
            if (alloy_1.default.isTablet)
                alloy_1.default.deepExtend(true, o, { color: "red", });
            alloy_1.default.deepExtend(true, o, { text: 'Hello, World', });
            return o;
        })());
        _this["__alloyId0"].add(_this["__alloyId1"]);
        _this["index"] = Ti.UI.createNavigationWindow((function () {
            var o = {};
            if (alloy_1.default.isTablet)
                alloy_1.default.deepExtend(true, o, { backgroundColor: "lime", });
            alloy_1.default.deepExtend(true, o, { backgroundColor: "#fff", fullscreen: false, exitOnClose: true, window: _this["__alloyId0"], id: "index", });
            return o;
        })());
