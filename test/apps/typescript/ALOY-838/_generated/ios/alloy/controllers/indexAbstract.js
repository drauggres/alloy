...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["button"] = Ti.UI.createButton({ title: alloy_1.default.CFG.button, backgroundColor: alloy_1.default.CFG.osOnly, borderColor: alloy_1.default.CFG.envOnly, id: "button", });
        _this["index"].add(_this["button"]);
        _this["button"] && _this.addListener(_this["button"], 'click', _this.doClick.bind(_this));
        // </viewCode>
        // Populating $.__views for backward compatibility
        // <__views>
        _this.__views["button"] = _this.button;
