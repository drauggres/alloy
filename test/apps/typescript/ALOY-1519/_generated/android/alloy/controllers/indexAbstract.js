...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["__alloyId1"] = Ti.UI.createRefreshControl({ tintColor: "red", });
        _this["__alloyId1"] && _this.addListener(_this["__alloyId1"], 'refreshstart', _this.doRefresh.bind(_this));
        _this["__alloyId0"] = Ti.UI.createScrollView({ refreshControl: _this["__alloyId1"], });
        _this["index"].add(_this["__alloyId0"]);
        _this["__alloyId2"] = Ti.UI.createLabel({ text: 'Hello', });
        _this["__alloyId0"].add(_this["__alloyId2"]);
        // </viewCode>
