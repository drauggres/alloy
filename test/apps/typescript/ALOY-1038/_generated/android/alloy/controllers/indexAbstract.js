...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["explain"] = Ti.UI.createLabel({ color: "blue", font: { fontSize: "10dp", fontStyle: "italic", }, text: "You should see 6 labels above and 6 below the line", id: "explain", });
        _this["index"].add(_this["explain"]);
        if ((OS_ANDROID)) {
            _this["__alloyId1"] = Ti.UI.createLabel({ text: 'android', });
            _this["index"].add(_this["__alloyId1"]);
        }
        if ((OS_ANDROID || OS_MOBILEWEB)) {
            _this["__alloyId4"] = Ti.UI.createLabel({ text: 'android,mobileweb', });
        ...
        if ((OS_ANDROID || OS_MOBILEWEB || OS_WINDOWS)) {
            _this["__alloyId6"] = Ti.UI.createLabel({ text: '!ios', });
        ...
        if ((OS_MOBILEWEB || OS_ANDROID || OS_WINDOWS)) {
            _this["__alloyId9"] = Ti.UI.createLabel({ text: 'mobileweb,!ios', });
        ...
        _this["ios"] = Ti.UI.createLabel({ height: 0, id: "ios", });
        _this["index"].add(_this["ios"]);
        _this["android"] = Ti.UI.createLabel({ height: Ti.UI.SIZE, text: "TSS: android", id: "android", });
        _this["index"].add(_this["android"]);
        _this["mobileweb"] = Ti.UI.createLabel({ height: 0, id: "mobileweb", });
        _this["index"].add(_this["mobileweb"]);
        _this["iosmobileweb"] = Ti.UI.createLabel({ height: 0, id: "iosmobileweb", });
        _this["index"].add(_this["iosmobileweb"]);
        _this["androidmobileweb"] = Ti.UI.createLabel({ height: Ti.UI.SIZE, text: "TSS: android,mobileweb", id: "androidmobileweb", });
        ...
        _this["notios"] = Ti.UI.createLabel({ height: Ti.UI.SIZE, text: "!ios", id: "notios", });
        _this["index"].add(_this["notios"]);
        _this["notandroid"] = Ti.UI.createLabel({ height: 0, id: "notandroid", });
        ...
        _this["mobilewebNotios"] = Ti.UI.createLabel({ height: Ti.UI.SIZE, text: "TSS: mobileweb,!ios", id: "mobilewebNotios", });
        _this["index"].add(_this["mobilewebNotios"]);
        _this["mobilewebNotandroid"] = Ti.UI.createLabel({ height: 0, id: "mobilewebNotandroid", });
