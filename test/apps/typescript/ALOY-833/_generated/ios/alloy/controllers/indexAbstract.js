...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        var __alloyId8 = [];
        _this["__alloyId9"] = alloy_1.default.createWidget('tony.section', 'widget', {});
        __alloyId8.push(_this["__alloyId9"].getViewEx({ recurse: true }));
        _this["__alloyId5"] = Ti.UI.createTableView({ data: __alloyId8, });
