...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        // Generated UI code
        // <viewCode>
        _this["index"] = Ti.UI.createWindow({ backgroundColor: "#fff", fullscreen: false, id: "index", });
        _this["index"] && _this.addTopLevelView(_this["index"]);
        _this["label"] = Ti.UI.createLabel((function () {
            var o = {};
            alloy_1.default.deepExtend(true, o, { height: Ti.UI.SIZE, width: "90%", font: { fontSize: "24dp", fontWeight: "normal", }, textAlign: "center", color: "#0f0", });
            if (alloy_1.default.isHandheld)
                alloy_1.default.deepExtend(true, o, { color: "#0ff", });
            if (alloy_1.default.isTablet)
                alloy_1.default.deepExtend(true, o, { color: "#963", });
            alloy_1.default.deepExtend(true, o, { text: 'Check the console output and make sure that only styles relevant to the current build platform are listed in the printed array. Note also that the "platform" key has been removed entirely from the "queries" object in conditional styles.', id: "label", });
            return o;
        })());
