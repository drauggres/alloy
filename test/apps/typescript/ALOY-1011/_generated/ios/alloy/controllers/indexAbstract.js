...
var indexAbstract = /** @class */ (function (_super) {
    ...
    function indexAbstract(args) {
        ...
        _this["bottomview"] = Ti.UI.createView({ bottom: 10, height: 200, backgroundColor: "orange", id: "bottomview", });
        _this["index"].add(_this["bottomview"]);
        _this["viewlabel"] = Ti.UI.createLabel({ width: Ti.UI.SIZE, height: Ti.UI.SIZE, color: "#fff", font: { fontSize: "20dp", }, text: "Not an Android!", id: "viewlabel", });
